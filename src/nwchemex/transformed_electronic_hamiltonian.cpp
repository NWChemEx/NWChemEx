...
MODULE_RUN(HDF5QCSchema) {
    ...
    HighFive::DataSet eps_dset =
      file.createDataSet( "scf_eigenvalues_a", eps_space, HighFive::AtomicType<double>() );
    ...
    HighFive::DataSet orb_dset =
      file.createDataSet( "scf_orbitals_a", ob_space, HighFive::AtomicType<double>() );
    ...
    HighFive::DataSpace ob_space(naos, naos);
    HighFive::DataSet core_h_dset =
      file.createDataSet( "scf_core_h_mo_a", ob_space, HighFive::AtomicType<double>() );
    ...
    HighFive::DataSet mo_eri_dset =
      file.createDataSet( "scf_eri_mo_aa", tb_space, HighFive::AtomicType<double>() );
