...
function(cppyy_make_python_package _cmpp_target)
    ...
    list(APPEND _cmpp_inc_dir ${property_types_SOURCE_DIR}/include ${sde_SOURCE_DIR}/include)
    list(APPEND _cmpp_inc_dir ${mp2_SOURCE_DIR}/include)
    ...
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${nwchemex_SOURCE_DIR}/include/nwchemex/load_modules.hpp\")\n")
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${libchemist_SOURCE_DIR}/include/libchemist/libchemist.hpp\")\n")
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${sde_SOURCE_DIR}/include/sde/module_manager.hpp\")\n")
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${mp2_SOURCE_DIR}/include/mp2/property_types/property_types.hpp\")\n")
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${property_types_SOURCE_DIR}/include/property_types/types.hpp\")\n")
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${property_types_SOURCE_DIR}/include/property_types/reference_wavefunction.hpp\")\n")
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${property_types_SOURCE_DIR}/include/property_types/correlation_energy.hpp\")\n")
    set(_cmpp_file "${_cmpp_file}\ncppyy.load_library(\"${CMAKE_BINARY_DIR}/${_cmpp_lib}\")\n\n")
    set(_cmpp_file "${_cmpp_file}from cppyy.gbl import mp2, sde, libchemist, nwx, property_types, TA\n")
