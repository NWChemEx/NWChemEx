...
function(cppyy_make_python_package _cmpp_target)
    ...
    set(_cmpp_file "${_cmpp_file}cppyy.include(\"${nwchemex_SOURCE_DIR}/include/nwchemex/madness_cling.hpp\")\n")
    ...
    set(_cmpp_file "${_cmpp_file}cppyy.gbl.madness.RMI.get_this_thread_is_server = cppyy.gbl.madness.workaround_RMI_get_this_thread_is_server\n\n")
